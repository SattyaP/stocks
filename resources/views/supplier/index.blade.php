...
@section('content')
    <div class="container">
        <div class="d-flex">
            <div>
                <h2 class="fw-bold">List Supplier</h2>
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item text-decoration-underline"><a href="{{ route('supplier.index') }}">Supplier</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ route('supplier.create') }}"
                            class="btn btn-primary mb-3">{{ __('Tambah Supplier') }}</a>
